...
class WeeklyStockChartWidget extends StatelessWidget {
  const WeeklyStockChartWidget({
    super.key,
    required this.data,
  });

  final Map<String, WeeklyData> data;

  @override
  Widget build(BuildContext context) {
    return SfCartesianChart(
      title: ChartTitle(text: 'Weekly Stock Data'),
      primaryXAxis: DateTimeAxis(
        dateFormat: DateFormat('MMM dd'), // Example date format for weekly
      ...
      series: <CartesianSeries>[
        CandleSeries<MapEntry<String, WeeklyData>, DateTime>(
        ...
        ColumnSeries<MapEntry<String, WeeklyData>, DateTime>(
          yAxisName: 'Y-Axis',
          dataSource: data.entries.toList(),
          xValueMapper: (data, _) => DateTime.parse(data.key),
