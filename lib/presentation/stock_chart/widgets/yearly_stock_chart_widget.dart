...
// class YearlyStockChartWidget extends StatelessWidget {
//   const YearlyStockChartWidget({
//     super.key,
//     required this.data,
//   });
...
//       title: ChartTitle(text: 'Yearly Stock Data'),
...
//         CandleSeries<YearlyData, DateTime>(
...
//         ),
//         ColumnSeries<MapEntry<String, YearlyData>, DateTime>(
//           yAxisName: 'Y-Axis',
//           dataSource: data.entries.toList(),
//           xValueMapper: (data, _) => DateTime.parse(data.key),
