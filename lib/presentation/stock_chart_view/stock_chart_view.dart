...
import 'package:trendscope/presentation/stock_chart_view/stock_chart_provider.dart';
          ...
          return SfCartesianChart(
            ...
            series: <CartesianSeries>[
              CandleSeries<MapEntry<String, DailyData>, DateTime>(
                ...
                closeValueMapper: (data, _) =>
                    double.tryParse(data.value.close),
              ),
              ColumnSeries<MapEntry<String, DailyData>, DateTime>(
                  ...
                  xValueMapper: (data, _) => DateTime.parse(data.key),
                  yValueMapper: (data, _) =>
                      double.tryParse(data.value.volume)),
            ],
          );
        },
